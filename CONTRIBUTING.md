Contributing to Cubis
============================

The Cubis project operates an open contributor model where anyone is
...
The following applies to code changes to the Cubis project, and is not to be
confused with overall CUBIS Network Protocol consensus changes.

Whether a pull request is merged into Cubis rests with the project merge
...
Patches that change CUBIS consensus rules are considerably more involved than
...
Where a patch set proposes to change the CUBIS consensus, it must have been
...
The project leader is the release manager for each Cubis release.

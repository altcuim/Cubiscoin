...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("Cubis RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  cubis-cli [options] <command> [params]  " + _("Send command to Cubis") + "\n" +
                        "  cubis-cli [options] help                " + _("List commands") + "\n" +
                        "  cubis-cli [options] help <command>      " + _("Get help for a command") + "\n";

/* src/config/cubis-config.h.  Generated from cubis-config.h.in by configure.  */
/* src/config/cubis-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Cubis_CONFIG_H

#define Cubis_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.cubis.co"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cubis Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cubis Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cubis"

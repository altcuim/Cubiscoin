                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    GUIUtil::restoreWindowGeometry("nWindow", QSize(850, 420), this);

    QString windowTitle = tr("Cubis") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CUBIS address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cubis: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cubis"), this);
    aboutAction->setStatusTip(tr("Show information about Cubis"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CUBIS"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CUBIS addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CUBIS addresses"));
    ...
    openAction->setStatusTip(tr("Open a CUBIS: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cubis help message to get a list with possible CUBIS command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cubis client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CUBIS network", "", count));
}
...
{
    QString strTitle = tr("Cubis"); // default title

...
/** Utility functions used by the CUBIS Qt UI.
 */
namespace GUIUtil
{
...
// Render CUBIS addresses in monospace font
...
// Parse "cubis:" URI into recipient object, return true on successful parsing

...
RESOURCES += src/qt/cubis.qrc src/qt/cubis_locale.qrc

TRANSLATIONS += src/qt/locale/cubis_bg.ts \
                src/qt/locale/cubis_de.ts \
                src/qt/locale/cubis_en.ts \
                src/qt/locale/cubis_es.ts \
                src/qt/locale/cubis_fi.ts \
                src/qt/locale/cubis_fr.ts \
                src/qt/locale/cubis_it.ts \
                src/qt/locale/cubis_ja.ts \
                src/qt/locale/cubis_pl.ts \
                src/qt/locale/cubis_pt.ts \
                src/qt/locale/cubis_ru.ts \
                src/qt/locale/cubis_sk.ts \
                src/qt/locale/cubis_sv.ts \
                src/qt/locale/cubis_vi.ts \
                src/qt/locale/cubis_zh_CN.ts \
                src/qt/locale/cubis_zh_TW.ts

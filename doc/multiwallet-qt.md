...
In order to support loading of multiple wallets in cubis-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cubis.cpp.
...
Changes to cubis.cpp
----------------------
cubis.cpp is the entry point into cubis-qt, and as such, will require some minor modifications to provide hooks for

...
This means one can have an always-on cubisd instance running, and another local cubisd/cubis-qt instance which connects to this node and receives blocks from it.
